...
frappe.ui.form.on('Date Notification', {
	...
	get_date_fields: function(frm) {
		frappe.call({
			method: 'reflection_telegram.extra_notifications.doctype.date_notification.date_notification.get_date_fields',
	...
	event: function(frm) {
		if(frm.doc.enable) {
			frm.add_custom_button(__('Get Alerts for Today'), function() {
				frappe.call({
					method: 'reflection_telegram.extra_notifications.doctype.date_notification.date_notification.get_documents_for_today',
					// method: 'reflection_telegram.extra_notifications.doctype.date_notification.date_notification.trigger_daily_alerts',
					args: {
